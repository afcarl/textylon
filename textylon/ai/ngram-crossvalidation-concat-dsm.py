...
from com.textylon.util.externalvectors import loadExternalRepresentation
...
voc, mat = loadExternalRepresentation('/home/af/Documents/1deep learning/word2vec/vectorsw5d1000.txt')
print("building dsm centroid for each document")
dsmvectorer = DSMVectorizer()
doc_centroids = dsmvectorer.fit_transform(data_target.data, mat, voc)
print "extracted doc dsm centroids with shape:"
print doc_centroids.shape
