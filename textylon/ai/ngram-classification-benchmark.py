...
# matplotlib.use('Agg')
DATA_FOLDER = "/home/af/Downloads/movie_review_kfold/review_polarity/9"
...
t0 = time()
vectorizer = TfidfVectorizer(sublinear_tf=True, min_df=0.002, max_df=1.0, ngram_range=(1, 3))
